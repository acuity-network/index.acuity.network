...
The [deliverables](/docs/proposals/1) from the previous referenda were largely completed and new version ([blog post](/blog/acuity-index-0.7.0)) of acuity-index-substrate and acuity-index-polkadot released.
